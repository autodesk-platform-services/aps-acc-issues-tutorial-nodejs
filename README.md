...
the [Forma Issue](https://tutorials.autodesk.io/tutorials/acc-issues) tutorial
from https://get-started.aps.autodesk.com/.

## Description
APS application that allows the authenticated user in [Autodesk Forma](https://www.autodesk.com/products/autodesk-docs/overview) to extract project issues and issues settings: sub types, root causes, custom attribute of a 
given a Forma project. This application renders these data in a tabular view. The data can also be exported to CSV
...
- Prepare a [ Forma Project with Issue Module Activated](https://help.autodesk.com/view/BUILD/ENU/?guid=Issues_About). Create some demo issues manually.
...
APS_CALLBACK_URL="http://localhost:8080/api/auth/callback" # URL your users will be redirected to after logging in with their Autodesk hub
...
- Export Issue Records: The application can extract all issues data from a project and render them in a table view. It also allows the user to save as the data to a csv file
 1. login with a valid user of this Forma project.
